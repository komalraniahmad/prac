...
class mpgepmcusersUserManager(BaseUserManager):
    ...
    def create_superuser(self, email, password, **extra_fields):
        ...
        extra_fields.setdefault('username', 'superuser') # ADDED: Default username for superuser
...
class mpgepmcusersUser(AbstractBaseUser, PermissionsMixin):
    ...
    # --- NEW FIELD: Username (Autogenerated, Unique) ---
    ...
    REQUIRED_FIELDS = ['first_name', 'last_name', 'gender', 'date_of_birth', 'mobile_number', 'username'] # UPDATED: Added 'username'
...
# ... (mpgepmcusersOTP model remains the same)
    """
...
# ... (mpgepmcusersPasswordResetToken model remains the same)
    """
...
# ... (MobileValidationRule model remains the same)
